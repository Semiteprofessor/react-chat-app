    ...
    <div className="flex flex-col flex-[2] border-l border-r border-[#dddddd35] h-[100%]">
          ...
          >
            <div className="flex-[1] flex flex-col gap-1">
              ...
              <p
                className={
                  message.senderId === currentUser?.id
                    ? "p-5 bg-[#5183fe] rounded-tl-xl rounded-bl-xl rounded-br-xl w-auto"
                    : "p-5 bg-[#bdc0c54d] rounded-tr-xl rounded-bl-xl rounded-br-xl w-auto"
                }
              >
                {message.text}
              </p>
      ...
      <div className="p-5 flex items-center justify-between border-t border-[#dddddd35] gap-5 mt-auto">
        ...
        <input
          ...
          className="disabled:cursor-not-allowed flex-[1] bg-[#11192880] border-none outline-none text-white p-5 rounded-md text-lg"
        />
        ...
        <button
          onClick={handleSend}
          disabled={isCurrentUserBlocked || isReceiverBlocked}
          className="disabled:bg-[#5182feb4] disabled:cursor-not-allowed bg-[#5183fe] text-white px-5 py-2 border-none rounded-md cursor-pointer"
        >
          Send
        </button>
      </div>
